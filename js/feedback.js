...
function check(){
  ...
  {
    email.style.borderColor="#EA7659";
  }if(feedback.email.value != "") 
  {
    email.style.borderColor="#ccc";
  }
  if(feedback.context.value == "") 
  {
    context.style.borderColor="#EA7659";
  }
  if(feedback.context.value != "") 
  {
    context.style.borderColor="#ccc";
  }
  if(feedback.context.value != "" && feedback.email.value != "" && feedback.name.value != "") 
  {
    alert("我們已收到您的意見");
    feedback.submit();
  }
